...
export default {
    ...
    async mounted() {
      console.log('Blogs Page Mounted', this.categoriesEndpoint, this.featureEndpoint);
      this.topicCategories = await get(this.categoriesEndpoint).then((res: any) => res.data);
    ...
    methods: {
      ...
      async fetchBlogs() {
        ...
        await get(this.featureEndpoint, {
          limit: 8,
